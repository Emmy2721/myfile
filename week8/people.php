...
<h1> Welcome to our People Database Class Excersice!</h1>
<?php
...
<p>For mote information about'.$row['first_name'].', click <a href="people-view.php?id='.$row['people_id'].' ">here</a></p>
';
} // end while 
